...
export const envPath: string | undefined =
...
export function getBinPathWithPreferredGopath(
  toolName: string,
  preferredGopaths: (string | undefined)[],
  ...
  if (toolName === "go") {
    const defaultPathForGo =
      process.platform === "win32" ? "C:\\Go\\bin\\go.exe" : "/usr/local/go/bin/go";
...
export function getInferredGopath(folderPath: string | undefined): string | undefined {
  if (!folderPath) {
    return;
  }
