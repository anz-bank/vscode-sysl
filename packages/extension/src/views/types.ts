...
export class SurfaceView<T extends ViewModel, D extends ViewModelDelta> implements View<T, D> {
  model?: T;
...
export interface Views {
  ...
  acceptOpenView<T extends ViewModel, D extends ViewModelDelta>(view: View<T, D>): void;
  acceptCloseView<T extends ViewModel, D extends ViewModelDelta>(view: View<T, D>): void;
  acceptShowView<T extends ViewModel, D extends ViewModelDelta>(view: View<T, D>): void;
  acceptHideView<T extends ViewModel, D extends ViewModelDelta>(view: View<T, D>): void;
  acceptChangeView<T extends ViewModel, D extends ViewModelDelta>(
    view: View<T, D>,
    change: D,
    model?: T
  ): void;
